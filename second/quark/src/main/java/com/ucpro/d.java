...
public final class d {
    ...
    public static final int[] CircleProgressBar = new int[]{R.attr.progress_value, R.attr.progress_color, R.attr.background_color, R.attr.progress_width, R.attr.background_width};
    ...
    public static final int[] CircularProgressView = new int[]{R.attr.cpv_progress, R.attr.cpv_maxProgress, R.attr.cpv_animDuration, R.attr.cpv_animSwoopDuration, R.attr.cpv_animSyncDuration, R.attr.cpv_color, R.attr.cpv_thickness, R.attr.cpv_indeterminate, R.attr.cpv_animAutostart, R.attr.cpv_animSteps, R.attr.cpv_startAngle};
    ...
    public static final int[] LottieAnimationView = new int[]{R.attr.lottie_fileName, R.attr.lottie_autoPlay, R.attr.lottie_loop, R.attr.lottie_imageAssetsFolder, R.attr.lottie_progress, R.attr.lottie_enableMergePathsForKitKatAndAbove, R.attr.lottie_cacheStrategy};
    ...
    public static final int[] MaterialEditText = new int[]{R.attr.met_baseColor, R.attr.met_primaryColor, R.attr.met_floatingLabel, R.attr.met_errorColor, R.attr.met_minCharacters, R.attr.met_maxCharacters, R.attr.met_singleLineEllipsis, R.attr.met_minBottomTextLines, R.attr.met_helperText, R.attr.met_helperTextColor, R.attr.met_accentTypeface, R.attr.met_typeface, R.attr.met_floatingLabelText, R.attr.met_floatingLabelPadding, R.attr.met_hideUnderline, R.attr.met_underlineColor, R.attr.met_autoValidate, R.attr.met_iconLeft, R.attr.met_iconRight, R.attr.met_iconPadding, R.attr.met_clearButton, R.attr.met_floatingLabelTextSize, R.attr.met_floatingLabelTextColor, R.attr.met_bottomTextSize, R.attr.met_floatingLabelAlwaysShown, R.attr.met_helperTextAlwaysShown, R.attr.met_floatingLabelAnimating, R.attr.met_textColor, R.attr.met_textColorHint, R.attr.met_validateOnFocusLost, R.attr.met_checkCharactersCountAtBeginning, R.attr.met_innerPaddingLeft, R.attr.met_innerPaddingRight, R.attr.met_innerPaddingTop, R.attr.met_innerPaddingBottom};
    ...
    public static final int MaterialEditText_met_innerPaddingBottom = 34;
    public static final int MaterialEditText_met_innerPaddingLeft = 31;
    public static final int MaterialEditText_met_innerPaddingRight = 32;
    public static final int MaterialEditText_met_innerPaddingTop = 33;
    ...
    public static final int TabLayout_tabIndicatorRadius = 3;
    public static final int TabLayout_tabIndicatorWidth = 2;
    public static final int TabLayout_tabMaxWidth = 9;
    public static final int TabLayout_tabMinWidth = 8;
    public static final int TabLayout_tabMode = 6;
    public static final int TabLayout_tabPadding = 17;
    public static final int TabLayout_tabPaddingBottom = 16;
    public static final int TabLayout_tabPaddingEnd = 15;
    public static final int TabLayout_tabPaddingStart = 13;
    public static final int TabLayout_tabPaddingTop = 14;
    public static final int TabLayout_tabSelectedTextColor = 12;
    public static final int TabLayout_tabTextAppearance = 10;
    ...
    public static final int[] innerrect = new int[]{R.attr.inner_width, R.attr.inner_height, R.attr.inner_margintop, R.attr.inner_corner_color, R.attr.inner_corner_length, R.attr.inner_corner_width, R.attr.inner_scan_bitmap, R.attr.inner_scan_speed, R.attr.inner_scan_iscircle};
