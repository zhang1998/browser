...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(5, MediaDefines.MSG_ENABLE_VR_MODE), new ECB(1, MediaDefines.MSG_DISABLE_VR_SENSOR));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(3, SecExceptionCode.SEC_ERROR_PLUGIN_REQUIREMENT_NOT_MEET), new ECB(4, SecExceptionCode.SEC_ERROR_INIT_EXTRACT_DIR_NOT_EXISTED));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(2, 111), new ECB(7, SecExceptionCode.SEC_ERROR_INIT_LOAD_INTERFACE_NOT_EXISTED));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(4, MediaDefines.MSG_DISABLE_VR_SENSOR), new ECB(5, 122));
        ...
        iArr = new int[]{6, 30, 58, 86, SecExceptionCode.SEC_ERROR_INIT_EXTRACT_DIR_NOT_EXISTED};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(10, SecExceptionCode.SEC_ERROR_INIT_EXTRACT_DIR_NOT_EXISTED), new ECB(2, 115));
        ...
        iArr = new int[]{6, 34, 60, 86, SecExceptionCode.SEC_ERROR_INIT_LOAD_INTERFACE_NOT_EXISTED, 138};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 30, 58, 86, SecExceptionCode.SEC_ERROR_INIT_EXTRACT_DIR_NOT_EXISTED, 142};
        eCBlocksArr = new ECBlocks[4];
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(12, MediaDefines.MSG_DISABLE_VR_SENSOR), new ECB(7, 122));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(6, MediaDefines.MSG_DISABLE_VR_SENSOR), new ECB(14, 122));
        ...
        iArr = new int[]{6, 30, 58, 86, SecExceptionCode.SEC_ERROR_INIT_EXTRACT_DIR_NOT_EXISTED, 142, 170};
        eCBlocksArr = new ECBlocks[4];
