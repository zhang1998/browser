...
public class a {
    ...
    public static DPoint a(Context context, DPoint dPoint) {
        ...
        String a = en.a(context, "libwgs2gcj.so");
        if (!(TextUtils.isEmpty(a) || !new File(a).exists() || b)) {
            try {
                System.load(a);
                b = true;
            } catch (Throwable th) {
                cq.a(th, "OffsetUtil", "offset");
            }
        }
        return a(dPoint, b);
    }
    ...
    private static DPoint a(DPoint dPoint, boolean z) {
        double[] dArr;
        try {
            if (!cq.a(dPoint.getLatitude(), dPoint.getLongitude())) {
                return dPoint;
            }
            double[] dArr2 = new double[2];
            if (z) {
                if (CoordUtil.convertToGcj(new double[]{dPoint.getLongitude(), dPoint.getLatitude()}, dArr2) != 0) {
                    dArr2 = dn.a(dPoint.getLongitude(), dPoint.getLatitude());
                }
                dArr = dArr2;
            } else {
                dArr = dn.a(dPoint.getLongitude(), dPoint.getLatitude());
            }
            return new DPoint(dArr[1], dArr[0]);
        } catch (Throwable th) {
            cq.a(th, "OffsetUtil", "cover part2");
            return dPoint;
        }
    }
    ...
    public static DPoint b(Context context, DPoint dPoint) {
        try {
            dPoint = a(context, c(dPoint.getLongitude(), dPoint.getLatitude()));
        } catch (Throwable th) {
            cq.a(th, "OffsetUtil", "marbar2G");
        }
        return dPoint;
    }
