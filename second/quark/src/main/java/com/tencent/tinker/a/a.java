...
public final class a {
    public static int a(InputStream inputStream, InputStream inputStream2, File file) throws IOException {
        ...
        byte[] a = b.a(inputStream);
        byte[] a2 = b.a(inputStream2);
        int length = a.length;
        int length2 = a2.length;
        DataInputStream dataInputStream = new DataInputStream(new ByteArrayInputStream(a2, 0, length2));
        dataInputStream.skip(8);
        long readLong = dataInputStream.readLong();
        long readLong2 = dataInputStream.readLong();
        int readLong3 = (int) dataInputStream.readLong();
        dataInputStream.close();
        InputStream byteArrayInputStream = new ByteArrayInputStream(a2, 0, length2);
        ...
        byteArrayInputStream = new ByteArrayInputStream(a2, 0, length2);
