...
final class WXApiImplV10 implements IWXAPI {
    ...
    final class ActivityLifecycleCb implements ActivityLifecycleCallbacks {
        ...
        private ActivityLifecycleCb(Context context) {
            ...
            this.onPausedRunnable = new Runnable() {
                public void run() {
                    if (WXApiImplV10.activityCb != null && ActivityLifecycleCb.this.isForeground) {
                        ah.a(ActivityLifecycleCb.this.context, "onBackground_WX");
            ...
            this.onResumedRunnable = new Runnable() {
                public void run() {
                    if (WXApiImplV10.activityCb != null && !ActivityLifecycleCb.this.isForeground) {
                        ah.a(ActivityLifecycleCb.this.context, "onForeground_WX");
    ...
    private void initMta(Context context, String str) {
        ...
        i.a(o.PERIOD);
        i.k();
        i.b(context, "Wechat_Sdk");
        try {
            ah.a(context, str2, "2.0.3");
        } catch (a e) {
        }
    }
