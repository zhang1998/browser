    ...
    public class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            try {
                ...
                b.b(WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " + pathOldToNew + ", ex = " + e.getMessage());
                return wXMediaMessage;
            }
        }
        ...
        private static String pathNewToOld(String str) {
            ...
            b.b(WXMediaMessage.TAG, "pathNewToOld fail, newPath is null");
            return str;
        }
        ...
        private static String pathOldToNew(String str) {
            ...
            b.b(WXMediaMessage.TAG, "pathOldToNew fail, oldPath is null");
            return str;
        }
