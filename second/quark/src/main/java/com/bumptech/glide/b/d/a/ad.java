...
public final class ad extends FilterInputStream {
    ...
    public ad(InputStream inputStream, b bVar) {
        this(inputStream, bVar, (byte) 0);
    }

    private ad(InputStream inputStream, b bVar, byte b) {
        super(inputStream);
        this.d = -1;
        this.f = bVar;
    ...
    L_0x0098:
        ...
        goto L_0x0047;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.b.d.a.ad.read(byte[], int, int):int");
    }
    ...
    public final synchronized void reset() throws IOException {
        if (this.a == null) {
            ...
            throw new ac("Mark has been invalidated, pos: " + this.e + " markLimit: " + this.c);
        } else {
            this.e = this.d;
        }
    }
