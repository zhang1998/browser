...
public class SecExceptionCode {
    ...
    public static final int SEC_ERROR_SAFETOKEN_CALL_VM_FAILED = 1614;
    ...
    public static final int SEC_ERROR_SAFETOKEN_INVALID_ENCRYPTED = 1613;
    ...
    public static final int SEC_ERROR_SAFETOKEN_INVALID_TOKEN_ENCRYPTED = 1611;
    public static final int SEC_ERROR_SAFETOKEN_INVALID_TOKEN_FORMAT = 1610;
    public static final int SEC_ERROR_SAFETOKEN_LOW_VERISON_JPG = 1609;
    public static final int SEC_ERROR_SAFETOKEN_NO_DATA_FILE = 1603;
    public static final int SEC_ERROR_SAFETOKEN_NO_MEMORY = 1606;
    public static final int SEC_ERROR_SAFETOKEN_TOKEN_NOT_EXIST = 1612;
    ...
    public static final int SEC_ERROR_UMID_INVALID_PARAM = 902;
    public static final int SEC_ERROR_UMID_NO_NETWORK_INIT = 901;
