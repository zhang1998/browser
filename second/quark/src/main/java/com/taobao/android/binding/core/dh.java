...
final class dh implements bg {
    ...
    public final Object a(ArrayList<Object> arrayList) {
        ...
        return Double.valueOf(((Math.sin((((doubleValue * doubleValue4) - min) * 6.283185307179586d) / d) * (Math.pow(2.0d, -10.0d * doubleValue) * doubleValue3)) + doubleValue3) + doubleValue2);
    }
}
