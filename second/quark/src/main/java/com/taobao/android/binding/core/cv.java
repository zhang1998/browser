...
final class cv implements bg {
    ...
    public final Object a(ArrayList<Object> arrayList) throws NumberFormatException, JSONException {
        ...
        if (doubleValue4 < 1.0d) {
            return Double.valueOf((doubleValue4 * (((((doubleValue3 / 2.0d) * doubleValue4) * doubleValue4) * doubleValue4) * doubleValue4)) + doubleValue2);
        }
        doubleValue4 -= 2.0d;
        return Double.valueOf((((doubleValue4 * (((doubleValue4 * doubleValue4) * doubleValue4) * doubleValue4)) + 2.0d) * (doubleValue3 / 2.0d)) + doubleValue2);
    }
}
