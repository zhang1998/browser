...
public class Utils {
    ...
    public static String timeFormat(int i) {
        ...
        int i4 = (i2 / 60) % 60;
        int i5 = i2 / 3600;
        Formatter formatter = (Formatter) a.get();
        if (i5 != 0) {
    ...
    public static boolean checkSupportSamplerExternalOES() {
        ...
        if (egl10.eglGetCurrentContext() == EGL10.EGL_NO_CONTEXT) {
            ...
            if (glGetString2.toLowerCase().contains("google") && glGetString3.toLowerCase().contains("emulator")) {
                return true;
            }
    ...
    protected static void setProxyAddress(String str) {
        ...
        if (iGlobalSettings != null) {
            iGlobalSettings.setStringValue(SettingKeys.NetworkFoxyServerAddr, str);
            iGlobalSettings.setStringValue(SettingKeys.NetworkWifiFoxyServerAddr, str);
        }
    }
}
