...
public class WebChromeClientCompatibility extends WebChromeClient {
    ...
    /* compiled from: ProGuard */
    final class a extends FileChooserParams {
        final /* synthetic */ WebChromeClientCompatibility a;
        private WebChromeClient.FileChooserParams b;

        a(WebChromeClientCompatibility webChromeClientCompatibility, WebChromeClient.FileChooserParams fileChooserParams) {
            this.a = webChromeClientCompatibility;
