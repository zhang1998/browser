...
public final class t extends WebViewClient {
    ...
    @TargetApi(23)
    /* compiled from: ProGuard */
    final class a extends WebResourceError {
    ...
    public final boolean shouldOverrideUrlLoading(android.webkit.WebView webView, WebResourceRequest webResourceRequest) {
        return this.b.shouldOverrideUrlLoading(this.a, new com.uc.webview.export.WebResourceRequest(webResourceRequest.getMethod(), (HashMap) webResourceRequest.getRequestHeaders(), webResourceRequest.getUrl().toString(), webResourceRequest.hasGesture(), webResourceRequest.isForMainFrame()));
    }
    ...
    public final WebResourceResponse shouldInterceptRequest(android.webkit.WebView webView, String str) {
        com.uc.webview.export.WebResourceResponse preloadResource;
                    ...
                    if (settings != null) {
                        ...
                        if (preCacheScope != null && preCacheScope.length() > 0) {
                            ...
                            if (iPreloadManager != null) {
                                preloadResource = iPreloadManager.getPreloadResource(preCacheScope, IPreloadManager.SIR_COMMON_TYPE, str);
                                shouldInterceptRequest = preloadResource;
                                if (shouldInterceptRequest == null) {
                                    return null;
                                }
        ...
        preloadResource = shouldInterceptRequest;
        shouldInterceptRequest = preloadResource;
        if (shouldInterceptRequest == null) {
            return null;
        }
    ...
    public final void onReceivedError(android.webkit.WebView webView, WebResourceRequest webResourceRequest, android.webkit.WebResourceError webResourceError) {
        ...
        this.b.onReceivedError(this.a, new com.uc.webview.export.WebResourceRequest(webResourceRequest.getMethod(), (HashMap) webResourceRequest.getRequestHeaders(), webResourceRequest.getUrl(), webResourceRequest.hasGesture(), webResourceRequest.isForMainFrame()), new a(webResourceError));
    }
    ...
    public final void onReceivedHttpError(android.webkit.WebView webView, WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
        com.uc.webview.export.WebResourceRequest webResourceRequest2 = new com.uc.webview.export.WebResourceRequest(webResourceRequest.getMethod(), (HashMap) webResourceRequest.getRequestHeaders(), webResourceRequest.getUrl(), webResourceRequest.hasGesture(), webResourceRequest.isForMainFrame());
