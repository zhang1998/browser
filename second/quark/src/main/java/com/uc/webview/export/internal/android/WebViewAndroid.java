...
public class WebViewAndroid extends WebView implements IWebView {
    ...
    final class a implements IHitTestResult {
        final /* synthetic */ WebViewAndroid a;
        private HitTestResult b;

        private a(WebViewAndroid webViewAndroid, HitTestResult hitTestResult) {
            this.a = webViewAndroid;
    ...
    public Object createWebMessageChannelInner() {
        ...
        Object obj = new n[createWebMessageChannel.length];
        for (int i = 0; i < createWebMessageChannel.length; i++) {
            obj[i] = new n(createWebMessageChannel[i]);
        }
        return obj;
    }
