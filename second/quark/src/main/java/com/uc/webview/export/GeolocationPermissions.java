    ...
    private static synchronized GeolocationPermissions a(int i) throws RuntimeException {
        ...
        synchronized (GeolocationPermissions.class) {
            ...
            if (geolocationPermissions == null) {
                GeolocationPermissions geolocationPermissions2 = new GeolocationPermissions((IGeolocationPermissions) SDKFactory.invoke(UCAsyncTask.isPaused, Integer.valueOf(i)));
