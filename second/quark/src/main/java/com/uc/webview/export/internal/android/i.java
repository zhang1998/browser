...
final class i extends WebChromeClientCompatibility implements IOpenFileChooser {
    ...
    /* compiled from: ProGuard */
    final class a implements CustomViewCallback {
        final /* synthetic */ i a;
        private WebChromeClient.CustomViewCallback b;

        public a(i iVar, WebChromeClient.CustomViewCallback customViewCallback) {
            this.a = iVar;
    ...
    final class b implements Callback {
        ...
        public b(i iVar, GeolocationPermissions.Callback callback) {
            this.a = iVar;
            this.b = callback;
        }
    ...
    public final void onShowCustomView(View view, WebChromeClient.CustomViewCallback customViewCallback) {
        this.b.onShowCustomView(view, new a(this, customViewCallback));
    }
    ...
    public final boolean onCreateWindow(android.webkit.WebView webView, boolean z, boolean z2, Message message) {
        ...
        webView2.getClass();
        WebView.WebViewTransport webViewTransport2 = new WebView.WebViewTransport(webView2);
    ...
    public final void onGeolocationPermissionsShowPrompt(String str, GeolocationPermissions.Callback callback) {
        this.b.onGeolocationPermissionsShowPrompt(str, new b(this, callback));
    }
