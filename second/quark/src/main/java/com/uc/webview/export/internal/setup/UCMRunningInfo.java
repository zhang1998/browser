...
public class UCMRunningInfo {
    ...
    public UCMRunningInfo(Context context, UCMPackageInfo uCMPackageInfo, ClassLoader classLoader, ClassLoader classLoader2, boolean z, boolean z2, UCMobileWebKit uCMobileWebKit, int i) {
