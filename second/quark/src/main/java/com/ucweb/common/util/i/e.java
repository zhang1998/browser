...
public final class e {
    ...
    public static final Pattern d = Pattern.compile("^((qk)\\:\\/\\/)", 2);
    public static final Pattern e = Pattern.compile("^((sms|smsto|mms|mmsto|tel|about|ucd|ext)\\:)", 2);
    ...
    private static boolean c(String str) {
        try {
            if (d.matcher(str).find() || e.matcher(str).find()) {
                return true;
            }
        } catch (Exception e) {
        }
