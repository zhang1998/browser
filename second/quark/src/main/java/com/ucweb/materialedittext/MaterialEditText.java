...
public class MaterialEditText extends AppCompatEditText {
    ...
    private int charactersCounterTextColor = -1;
    ...
    private int underlineSelectHeight = -1;
    ...
    public void setUnderLineHight(int i) {
        this.underlineHeight = i;
        postInvalidate();
    }

    public void setUnderLineSelectHight(int i) {
        this.underlineSelectHeight = i;
        postInvalidate();
    }
    ...
    private void initFloatingLabel() {
        ...
        this.innerFocusChangeListener = new OnFocusChangeListener() {
            public void onFocusChange(View view, boolean z) {
                ...
                if (MaterialEditText.this.validateOnFocusLost && !z) {
                    MaterialEditText.this.validate();
                }
    ...
    public void setCharactersCounterTextColor(int i) {
        this.charactersCounterTextColor = i;
    }

    protected void onDraw(@NonNull Canvas canvas) {
        float f;
        float f2;
        int scrollX = ((this.iconLeftBitmaps == null ? 0 : this.iconOuterWidth + this.iconPadding) + getScrollX()) + getPaddingLeft();
        int width = ((this.iconRightBitmaps == null ? getWidth() : (getWidth() - this.iconOuterWidth) - this.iconPadding) + getScrollX()) - getPaddingRight();
        ...
        if (this.iconRightBitmaps != null) {
            ...
            bitmap = bitmapArr[i];
            canvas.drawBitmap(bitmap, (float) ((this.iconPadding + width) + ((this.iconOuterWidth - bitmap.getWidth()) / 2)), (float) (((this.bottomSpacing + scrollY) - this.iconOuterHeight) + ((this.iconOuterHeight - bitmap.getHeight()) / 2)), this.paint);
        }
        ...
        if (!this.hideUnderline) {
            ...
            if (!isInternalValid()) {
                ...
                float pixel2 = (float) getPixel(1);
                for (float f4 = 0.0f; f4 < ((float) getWidth()); f4 = (IPictureView.DEFAULT_MAX_SCALE * pixel2) + f4) {
                    canvas.drawRect(((float) scrollX) + f4, (float) scrollY, (((float) scrollX) + f4) + pixel2, (float) (getPixel(1) + scrollY), this.paint);
                }
            } else if (hasFocus()) {
                this.paint.setColor(this.primaryColor);
                canvas.drawRect((float) scrollX, (float) scrollY, (float) width, (float) ((this.underlineSelectHeight == -1 ? getPixel(2) : this.underlineSelectHeight) + scrollY), this.paint);
            } else {
                this.paint.setColor(this.underlineColor != -1 ? this.underlineColor : (this.baseColor & 16777215) | 503316480);
                f = (float) scrollX;
                f2 = (float) scrollY;
                f3 = (float) width;
                if (this.underlineHeight == -1) {
                    pixel = getPixel(1);
                    i2 = scrollY;
                    canvas2 = canvas;
                } else {
                    pixel = this.underlineHeight;
                    i2 = scrollY;
                    canvas2 = canvas;
                }
            }
            canvas2.drawRect(f, f2, f3, (float) (pixel + i2), this.paint);
        }
        this.textPaint.setTextSize((float) this.bottomTextSize);
        FontMetrics fontMetrics = this.textPaint.getFontMetrics();
        f = (-fontMetrics.ascent) - fontMetrics.descent;
        f2 = (((float) this.bottomTextSize) + fontMetrics.ascent) + fontMetrics.descent;
        if ((hasFocus() && hasCharactersCounter()) || !isCharactersCountValid()) {
            TextPaint textPaint = this.textPaint;
            i = isCharactersCountValid() ? this.charactersCounterTextColor != -1 ? this.charactersCounterTextColor : (this.baseColor & 16777215) | 1140850688 : this.errorColor;
            textPaint.setColor(i);
            String charactersCounterText = getCharactersCounterText();
            canvas.drawText(charactersCounterText, isRTL() ? (float) scrollX : ((float) width) - this.textPaint.measureText(charactersCounterText), f + ((float) (this.bottomSpacing + scrollY)), this.textPaint);
        }
        if (this.textLayout != null && (this.tempErrorText != null || ((this.helperTextAlwaysShown || hasFocus()) && !TextUtils.isEmpty(this.helperText)))) {
            ...
            canvas.save();
            if (isRTL()) {
                canvas.translate((float) (width - this.textLayout.getWidth()), ((float) (this.bottomSpacing + scrollY)) - f2);
            } else {
                canvas.translate((float) (getBottomTextLeftOffset() + scrollX), ((float) (this.bottomSpacing + scrollY)) - f2);
            }
        ...
        if (hasFocus() && this.singleLineEllipsis && getScrollX() != 0) {
            ...
            f = (float) (this.bottomSpacing + scrollY);
            if (isRTL()) {
                scrollX = width;
            }
            i = isRTL() ? -1 : 1;
            canvas.drawCircle((float) (((this.bottomEllipsisSize * i) / 2) + scrollX), ((float) (this.bottomEllipsisSize / 2)) + f, (float) (this.bottomEllipsisSize / 2), this.paint);
            canvas.drawCircle((float) ((((this.bottomEllipsisSize * i) * 5) / 2) + scrollX), ((float) (this.bottomEllipsisSize / 2)) + f, (float) (this.bottomEllipsisSize / 2), this.paint);
            canvas.drawCircle((float) ((((i * this.bottomEllipsisSize) * 9) / 2) + scrollX), f + ((float) (this.bottomEllipsisSize / 2)), (float) (this.bottomEllipsisSize / 2), this.paint);
        }
        super.onDraw(canvas);
    }
