...
public final class Buffer implements Cloneable, BufferedSink, BufferedSource {
    ...
    public final long completeSegmentByteCount() {
        ...
        if (segment.limit >= SpdyProtocol.SLIGHTSSL_1_RTT_MODE || !segment.owner) {
            return j;
        }
    ...
    final int selectPrefix(Options options) {
        Segment segment = this.head;
        ByteString[] byteStringArr = options.byteStrings;
        int length = byteStringArr.length;
    ...
    public final int readUtf8CodePoint() throws EOFException {
        ...
        if ((b & 128) == 0) {
            i = 0;
            i2 = b & UCCore.SPEEDUP_DEXOPT_POLICY_DAVIK;
            i3 = 1;
        } else if ((b & 224) == 192) {
            i2 = b & 31;
            i3 = 2;
        ...
        skip((long) i3);
        return i5 > 1114111 ? REPLACEMENT_CHARACTER : (i5 < 55296 || i5 > 57343) ? i5 < i ? REPLACEMENT_CHARACTER : i5 : REPLACEMENT_CHARACTER;
    }
    ...
    final Segment writableSegment(int i) {
        if (i <= 0 || i > SpdyProtocol.SLIGHTSSL_1_RTT_MODE) {
            ...
            r0 = this.head.prev;
            if (r0.limit + i > SpdyProtocol.SLIGHTSSL_1_RTT_MODE || !r0.owner) {
