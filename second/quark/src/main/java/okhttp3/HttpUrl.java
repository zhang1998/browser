...
public final class HttpUrl {
    ...
    public final class Builder {
        ...
        final ParseResult parse(HttpUrl httpUrl, String str) {
            ...
            if (slashCount >= 2 || httpUrl == null || !httpUrl.scheme.equals(this.scheme)) {
                ...
                while (true) {
                    ...
                    switch (delimiterOffset != skipTrailingAsciiWhitespace ? str.charAt(delimiterOffset) : '￿') {
                        ...
                        case '?':
                        case '\\':
                            slashCount = portColonOffset(str, i, delimiterOffset);
                            if (slashCount + 1 < delimiterOffset) {
                                this.host = canonicalizeHost(str, i, slashCount);
                                this.port = parsePort(str, slashCount + 1, delimiterOffset);
                                if (this.port == -1) {
            ...
            slashCount = Util.delimiterOffset(str, skipLeadingAsciiWhitespace, skipTrailingAsciiWhitespace, "?#");
            resolvePath(str, skipLeadingAsciiWhitespace, slashCount);
            if (slashCount >= skipTrailingAsciiWhitespace || str.charAt(slashCount) != '?') {
                skipLeadingAsciiWhitespace = slashCount;
            } else {
                skipLeadingAsciiWhitespace = Util.delimiterOffset(str, slashCount, skipTrailingAsciiWhitespace, '#');
                this.encodedQueryNamesAndValues = HttpUrl.queryStringToNamesAndValues(HttpUrl.canonicalize(str, slashCount + 1, skipLeadingAsciiWhitespace, HttpUrl.QUERY_ENCODE_SET, true, false, true, true));
            }
            if (skipLeadingAsciiWhitespace < skipTrailingAsciiWhitespace && str.charAt(skipLeadingAsciiWhitespace) == '#') {
        ...
        private static InetAddress decodeIpv6(String str, int i, int i2) {
            ...
            while (i6 < i2) {
                ...
                if (i6 + 2 > i2 || !str.regionMatches(i6, "::", 0, 2)) {
                    if (i5 != 0) {
                        if (str.regionMatches(i6, ":", 0, 1)) {
                            ...
                            if (!decodeIpv4Suffix(str, i3, i2, obj, i5 - 2)) {
                                return null;
                            }
                            i5 += 2;
                        }
                ...
                decodeHexDigit = i7 - i6;
                if (decodeHexDigit == 0 || decodeHexDigit > 4) {
                    return null;
                }
                decodeHexDigit = i5 + 1;
                obj[i5] = (byte) ((i3 >>> 8) & 255);
                i5 = decodeHexDigit + 1;
                obj[decodeHexDigit] = (byte) (i3 & 255);
                i3 = i6;
                i6 = i7;
            }
            if (i5 != 16) {
                ...
                System.arraycopy(obj, i4, obj, 16 - (i5 - i4), i5 - i4);
                Arrays.fill(obj, i4, (16 - i5) + i4, (byte) 0);
            }
            try {
    ...
    static String canonicalize(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        while (i3 < i2) {
            int codePointAt = str.codePointAt(i3);
            if (codePointAt < 32 || codePointAt == UCCore.SPEEDUP_DEXOPT_POLICY_DAVIK || ((codePointAt >= 128 && z4) || str2.indexOf(codePointAt) != -1 || ((codePointAt == 37 && (!z || (z2 && !percentEncoded(str, i3, i2)))) || (codePointAt == 43 && z3)))) {
                Buffer buffer = new Buffer();
                buffer.writeUtf8(str, i, i3);
    ...
    static void canonicalize(Buffer buffer, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        while (i < i2) {
            ...
            if (!(z && (codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13))) {
                ...
                } else if (codePointAt < 32 || codePointAt == UCCore.SPEEDUP_DEXOPT_POLICY_DAVIK || ((codePointAt >= 128 && z4) || str2.indexOf(codePointAt) != -1 || (codePointAt == 37 && (!z || (z2 && !percentEncoded(str, i, i2)))))) {
                    if (buffer2 == null) {
                        buffer2 = new Buffer();
                    }
